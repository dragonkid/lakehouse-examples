 ...
 * the License.
 */
package com.arecadata.clickstream.sink.shuffle;
...
class DataStatisticsOrRecordSerializer<D extends DataStatistics<D, S>, S>
    ...
    DataStatisticsOrRecordSerializer(TypeSerializer<DataStatistics<D, S>> statisticsSerializer,
    ...
    public TypeSerializer<DataStatisticsOrRecord<D, S>> duplicate() {
        ...
        if ((statisticsSerializer != duplicateStatisticsSerializer)
            ...
            return new DataStatisticsOrRecordSerializer<>(duplicateStatisticsSerializer,
                    duplicateRowDataSerializer);
        } else {
            return this;
        }
    }
    ...
    public DataStatisticsOrRecord<D, S> copy(DataStatisticsOrRecord<D, S> from) {
        if (from.hasRecord()) {
            ...
            return DataStatisticsOrRecord
                    .fromDataStatistics(statisticsSerializer.copy(from.dataStatistics()));
        }
    }
    ...
    public DataStatisticsOrRecord<D, S> deserialize(DataInputView source) throws IOException {
        ...
        if (isRecord) {
            ...
            return DataStatisticsOrRecord
                    .fromDataStatistics(statisticsSerializer.deserialize(source));
        }
    }

    @Override
    public DataStatisticsOrRecord<D, S> deserialize(DataStatisticsOrRecord<D, S> reuse,
    ...
    public static class DataStatisticsOrRecordSerializerSnapshot<D extends DataStatistics<D, S>, S>
            extends
            CompositeTypeSerializerSnapshot<DataStatisticsOrRecord<D, S>, DataStatisticsOrRecordSerializer<D, S>> {
        ...
        protected TypeSerializer<?>[] getNestedSerializers(
            ...
            return new TypeSerializer<?>[] {outerSerializer.statisticsSerializer,
        ...
        protected DataStatisticsOrRecordSerializer<D, S> createOuterSerializerWithNestedSerializers(
            ...
            TypeSerializer<RowData> recordSerializer =
                    (TypeSerializer<RowData>) nestedSerializers[1];
