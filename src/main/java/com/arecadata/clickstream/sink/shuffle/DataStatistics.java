 ...
 *
 * <p>
 * Data statistics tracks traffic volume distribution across data keys. For low-cardinality key, a
 * simple map of (key, count) can be used. For high-cardinality key, probabilistic data structures
