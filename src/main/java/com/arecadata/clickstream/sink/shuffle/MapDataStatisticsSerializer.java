...
class MapDataStatisticsSerializer
    ...
    public TypeSerializer<DataStatistics<MapDataStatistics, Map<RowData, Long>>> duplicate() {
        ...
        return (duplicateMapSerializer == mapSerializer) ? this
    ...
    public DataStatistics<MapDataStatistics, Map<RowData, Long>> copy(DataStatistics obj) {
        Preconditions.checkArgument(obj instanceof MapDataStatistics,
                "Invalid data statistics type: " + obj.getClass());
    ...
    @Override
    public DataStatistics<MapDataStatistics, Map<RowData, Long>> copy(DataStatistics from,
            DataStatistics reuse) {
    ...
    @Override
    public DataStatistics<MapDataStatistics, Map<RowData, Long>> deserialize(DataStatistics reuse,
    ...
    public static class MapDataStatisticsSerializerSnapshot extends
            CompositeTypeSerializerSnapshot<DataStatistics<MapDataStatistics, Map<RowData, Long>>, MapDataStatisticsSerializer> {
