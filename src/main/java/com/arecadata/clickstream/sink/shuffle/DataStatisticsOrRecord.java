 ...
 *
 * <p>
 * DataStatisticsOrRecord contains either data statistics(globally aggregated) or a record. It is
...
class DataStatisticsOrRecord<D extends DataStatistics<D, S>, S> implements Serializable {
    ...
    private DataStatisticsOrRecord(DataStatistics<D, S> statistics, RowData record) {
        Preconditions.checkArgument(record != null ^ statistics != null,
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("statistics", statistics).add("record", record)
                .toString();
    }
}
