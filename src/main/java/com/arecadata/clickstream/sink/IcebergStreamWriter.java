...
class IcebergStreamWriter<T> extends AbstractStreamOperator<WriteResult>
    ...
    public void processElement(StreamRecord<T> element) throws Exception {
        // // test if type field of element is delete
        // T elementValue = element.getValue();
        // if (elementValue instanceof org.apache.flink.table.data.GenericRowData) {
        // org.apache.flink.table.data.GenericRowData genericRowData =
        // (org.apache.flink.table.data.GenericRowData) elementValue;
        // if (genericRowData.getField(3).toString().equals("delete")) {
        // LOG.info("delete record: " + genericRowData.toString());
        // flush();
        // return;
        // }
        // } else if (elementValue instanceof org.apache.flink.types.Row) {
        // org.apache.flink.types.Row row = (org.apache.flink.types.Row) elementValue;
        // if (row.getField(3).toString().equals("delete")) {
        // LOG.info("delete record: " + row.toString());
        // flush();
        // this.writer = taskWriterFactory.create();
        // }
        // } else {
        // LOG.info("unknown type: " + elementValue.getClass().toString());
        // }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("table_name", fullTableName)
                .add("subtask_id", subTaskId).add("attempt_id", attemptId).toString();
    }
