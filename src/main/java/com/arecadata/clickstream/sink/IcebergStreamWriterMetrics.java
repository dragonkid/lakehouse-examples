...
class IcebergStreamWriterMetrics {
    ...
    IcebergStreamWriterMetrics(MetricGroup metrics, String fullTableName) {
        ...
        this.dataFilesSizeHistogram = writerMetrics.histogram("dataFilesSizeHistogram",
        ...
        com.codahale.metrics.Histogram dropwizardDeleteFilesSizeHistogram =
                new com.codahale.metrics.Histogram(
                        new SlidingWindowReservoir(HISTOGRAM_RESERVOIR_SIZE));
        this.deleteFilesSizeHistogram = writerMetrics.histogram("deleteFilesSizeHistogram",
    ...
    void updateFlushResult(WriteResult result) {
        ...
        // For file size distribution histogram, we don't have to update them after successful
        // commits.
        // This should works equally well and we avoided the overhead of tracking the list of file
        // sizes
