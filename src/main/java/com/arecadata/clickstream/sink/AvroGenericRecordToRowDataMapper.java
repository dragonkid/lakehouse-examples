...
// * time type, we can't directly use the Avro Schema converted from Iceberg schema via
// * {@link AvroSchemaUtil#convert(org.apache.iceberg.Schema, String)}.
// */
...
// RowType rowType =
// RowType.of(logicalType.getChildren().stream().toArray(LogicalType[]::new));
