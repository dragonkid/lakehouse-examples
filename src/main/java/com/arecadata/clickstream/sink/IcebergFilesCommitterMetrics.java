...
class IcebergFilesCommitterMetrics {
    ...
    IcebergFilesCommitterMetrics(MetricGroup metrics, String fullTableName) {
        ...
        committerMetrics.gauge("elapsedSecondsSinceLastSuccessfulCommit",
        ...
        this.committedDeleteFilesByteCount =
                committerMetrics.counter("committedDeleteFilesByteCount");
    }
     ...
     * {@link ElapsedTimeGauge#refreshLastRecordedTime()}.
     */
